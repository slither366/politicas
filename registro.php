				...
				<div class="panel panel-info">
					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								<label for="paterno" class="col-md-3 control-label">Paterno:</label>
								<div class="col-md-9">
							...
							<div class="form-group">
								<label for="materno" class="col-md-3 control-label">Materno:</label>
								<div class="col-md-9">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<select class="form-control" id="estado_civil" name="estado_civil">
										<option value="SOLTERO" <?php if($row['descripcion']=='SOLTERO') echo 'selected'; ?>>SOLTERO</option>
										<option value="CASADO" <?php if($row['descripcion']=='CASADO') echo 'selected'; ?>>CASADO</option>
										<option value="OTRO" <?php if($row['descripcion']=='OTRO') echo 'selected'; ?>>OTRO</option>
									</select>
								</div>
							</div>		
